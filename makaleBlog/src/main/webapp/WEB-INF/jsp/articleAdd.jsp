...
<body>
 ...
 <c:if test="${pageContext.request.userPrincipal.name != null}">
  ...
  <header class="masthead" style="background-image: url('resources/img/home-bg.jpg')">
	...
	<form:form action="articleAdd" modelAttribute="article" commandName="article"  method="POST">
		<table>
			<form:hidden path="id"/>
			<tr>
				...
				<td>
					...
					<form:errors path="articleTitle"/> 
				</td>
			</tr>
			<tr>
				<td>Makale Konu Basligi:</td>
				<td>
					<form:input id="articleSubTitle" path="articleSubTitle"/> 
					<form:errors path="articleSubTitle"/> 
				</td>
			</tr>
			<tr>
				<td>Makale Tarihi:</td>
